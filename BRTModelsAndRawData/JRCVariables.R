...
# RCModel1 = data.frame(matrix(ncol=0,nrow=31))
...
#          "elevation_b100000", "elevation_b50", "distance30_b100000p70", "distance1000_b100000p70", "distance5000_b100000p70", "travelTime_b100000", "travelTime_b1000", "precAv_b100000", 
#          "precAv_b50", "distance30_b100000p10", "distance30_b50p50", "distance30_b1000p70", "distance30_b100000p0", "distance500_b50p10", "distance1000_b10000p10", "distance5000_b100000p90", 
#          "waterArea_b100000p90", "distance30_b10000p10", "distance30_b10000p0", "waterNDWI_b100000p50", "waterNDWI_b100p50")
# RCModel1 <- RCModel1 %>% cbind(RCModel1, Rx1) %>% rename("var" = "Rx1")

RCModel2 = data.frame(matrix(ncol=0,nrow=23))
Rx2 <- c("NDVI_b50", "NDVI_b10000", "tempAv_b1000", "tempAv_b100000", 
         "elevation_b100000", "elevation_b50", "distance30_b100000p70", "distance1000_b100000p70", "distance5000_b100000p70", "travelTime_b100000", "travelTime_b1000", 
         "distance30_b100000p10", "distance30_b50p50", "distance30_b1000p70", "distance30_b100000p0", "distance500_b50p10", "distance1000_b10000p10", "distance5000_b100000p90", 
         "waterArea_b100000p90", "distance30_b10000p10", "distance30_b10000p0", "waterNDWI_b100000p50", "waterNDWI_b100p50")
RCModel2 <- RCModel2 %>% cbind(RCModel2, Rx2) %>% rename("var" = "Rx2")

# RCModel3 = data.frame(matrix(ncol=0,nrow=16))
# Rx3 <- c("NDVI_b50", "NDVI_b10000", "precMax_b50", "precMax_b10000", "precMin_b50", "precMin_b100000", "precMaxAmplitude_b50", "precMaxAmplitude_b10000","meanTemp_b1000", "meanTemp_b100000", 
#          "elevation_b100000", "elevation_b50", "travelTime_b100000", "travelTime_b1000", "total_precipitation_b100000", 
#          "total_precipitation_b50", "waterArea_b100000p0", "distance30_b100000p0", "waterArea_b100000p10", "distance30_b100000p10", "distance500_b100000p10", "distance1000_b100000p10", "distance5000_b100000p10", "waterArea_b100000p20", "distance30_b100000p20", "distance500_b100000p20", "distance1000_b100000p20", "distance5000_b100000p20", "waterArea_b100000p50", "distance30_b100000p50", "distance500_b100000p50", "distance1000_b100000p50", "distance5000_b100000p50", "waterArea_b100000p70", "distance30_b100000p70", "distance500_b100000p70", "distance1000_b100000p70", "distance5000_b100000p70", "waterArea_b100000p90", "distance30_b100000p90", "distance500_b100000p90", "distance1000_b100000p90", "distance5000_b100000p90")
# RCModel3 <- RCModel3 %>% cbind(RCModel3, Rx3) %>% rename("var" = "Rx3")
# 
# RCModel4 = data.frame(matrix(ncol=0,nrow=55))
# Rx4 <- c("NDVI_b50", "NDVI_b10000", "precMax_b50", "precMax_b10000", "precMin_b50", "precMin_b100000", "precMaxAmplitude_b50", "precMaxAmplitude_b10000","meanTemp_b1000", "meanTemp_b100000", 
#          "elevation_b100000", "elevation_b50", "travelTime_b100000", "travelTime_b1000", "total_precipitation_b100000", 
...
for ( i in 1:50){
  ...
  # #model 1: Confounders + all variables 
  ...
  #                             tempAv_b1000, tempAv_b100000, elevation_b100000, elevation_b50, distance30_b100000p70, distance1000_b100000p70, distance5000_b100000p70,
  #                             travelTime_b100000, travelTime_b1000, precAv_b100000, precAv_b50, waterNDWI_b100000p50,
  #                             distance30_b100000p10, distance30_b50p50, distance30_b1000p70, distance30_b100000p0, distance500_b50p10, distance1000_b10000p10, 
  #                             distance5000_b100000p90, waterArea_b100000p90, distance30_b10000p10, distance30_b10000p0, waterNDWI_b100p50))
  # BRT_malaria1 <- gbm.fixed(data=data1, gbm.x=2:32 ,gbm.y=1, family="gaussian", tree.complexity = 10, learning.rate = 0.005, n.trees = 5000,  bag.fraction = 0.6)
  # 
  # 
  #model 2: Confounders + surface water without precipitation -- low resolution without precipitation
  data2 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, 
                              tempAv_b1000, tempAv_b100000, elevation_b100000, elevation_b50, distance30_b100000p70, distance1000_b100000p70, distance5000_b100000p70,
                              travelTime_b100000, travelTime_b1000,  waterNDWI_b100000p50,
                              distance30_b100000p10, distance30_b50p50, distance30_b1000p70, distance30_b100000p0, distance500_b50p10, distance1000_b10000p10, 
                              distance5000_b100000p90, waterArea_b100000p90, distance30_b10000p10, distance30_b10000p0, waterNDWI_b100p50))
  BRT_malaria2 <- gbm.fixed(data=data2, gbm.x=2:24 ,gbm.y=1, family="gaussian", tree.complexity = 10, learning.rate = 0.005, n.trees = 5000,  bag.fraction = 0.6)
  ...
  #                             meanTemp_b1000, meanTemp_b100000, elevation_b100000, elevation_b50, travelTime_b100000, travelTime_b1000, total_precipitation_b100000, 
  #                             total_precipitation_b50, contains("_b100000p")))
  ...
  # Var1 <- partial(BRT_malaria1, pred.var = c("distance30_b100000p0"), train = data1, n.trees = 2000)
  # Var1Y <- cbind(Var1Y, Var1$yhat)
  # 
  # Var2 <- partial(BRT_malaria2, pred.var = c("distance30_b100000p0"), train = data2, n.trees = 2000)
