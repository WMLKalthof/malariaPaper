...
data <-  read.csv("statsCombinedDocuments/varNovelHighRes.csv")
...
Var3Y <- data.frame(matrix(ncol=0,nrow=51))
Var4Y <- data.frame(matrix(ncol=0,nrow=51))
Var5Y <- data.frame(matrix(ncol=0,nrow=51))
Var6Y <- data.frame(matrix(ncol=0,nrow=51))
Var7Y <- data.frame(matrix(ncol=0,nrow=51))
Var8Y <- data.frame(matrix(ncol=0,nrow=51))
...
RCModel1 = data.frame(matrix(ncol=0,nrow=33))
Rx1 <- c("NDVI_b50", "NDVI_b10000", "precMax_b50", "precMax_b10000", "precMin_b50", "precMin_b100000", "precMaxAmplitude_b50", "precMaxAmplitude_b10000","tempAv_b1000", "tempAv_b100000", 
         "elevation_b100000", "elevation_b50", "distance_b100000p70", "distance1000_b100000p70", "distance5000_b100000p70", "travelTime_b100000", "travelTime_b1000", "precAv_b100000", 
         "precAv_b50", "distance_b100000p10", "distance_b50p50", "distance_b1000p70", "distance_b100000p0", "distance500_b50p10", "distance1000_b10000p10", "distance5000_b100000p90", 
         "waterBodies_b10000p10", "waterBodies_b100000p10", "waterArea_b100000p90", "distance_b10000p10", "distance_b10000p0", "waterNDWI_b100000p50", "waterNDWI_b100p50")
RCModel1 <- RCModel1 %>% cbind(RCModel1, Rx1) %>% rename("var" = "Rx1")

RCModel2 = data.frame(matrix(ncol=0,nrow=25))
Rx2 <- c("NDVI_b50", "NDVI_b10000", "tempAv_b1000", "tempAv_b10000", "elevation_b100000", "elevation_b50", "distance_b100000p70", "distance1000_b100000p70", "distance5000_b100000p70", "travelTime_b100000", 
         "travelTime_b1000", "distance_b100000p10", "distance_b50p50", "distance_b1000p70", "distance_b100000p0", "distance500_b50p10", "distance1000_b10000p10", "distance5000_b100000p90", "waterBodies_b10000p10", 
         "waterBodies_b100000p10", "waterArea_b100000p90", "distance_b10000p10", "distance_b10000p0", "waterNDWI_b100000p50", "waterNDWI_b100p50")
RCModel2 <- RCModel2 %>% cbind(RCModel2, Rx2) %>% rename("var" = "Rx2")

RCModel3 = data.frame(matrix(ncol=0,nrow=16))
Rx3 <- c("NDVI_b50", "NDVI_b10000", "precMax_b50", "precMax_b10000", "precMin_b50", "precMin_b100000", "precMaxAmplitude_b50", "precMaxAmplitude_b10000", "tempAv_b1000", "tempAv_b100000", 
         "elevation_b100000", "elevation_b50", "travelTime_b100000", "travelTime_b1000", "precAv_b100000", "precAv_b50")
RCModel3 <- RCModel3 %>% cbind(RCModel3, Rx3) %>% rename("var" = "Rx3")

# RCModel4 = data.frame(matrix(ncol=0,nrow=31))
# Rx4 <- c("NDVI_b50", "NDVI_b10000", "precMax_b50", "precMax_b10000", "precMin_b50", "precMin_b100000", "precMaxAmplitude_b50", "precMaxAmplitude_b10000","tempAv_b1000", "tempAv_b100000", 
#          "elevation_b100000", "elevation_b50", "distance_b100000p70", "distance1000_b100000p70", "distance5000_b100000p70", "travelTime_b100000", "travelTime_b1000", "precAv_b100000", 
#          "precAv_b50", "distance_b100000p10", "distance_b50p50", "distance_b1000p90", "distance_b100000p20", "distance500_b50p10", "distance1000_b10000p10", "distance5000_b100000p90", 
#          "waterBodies_b10000p10", "waterBodies_b100000p10", "waterArea_b100000p90", "distance_b10000p10", "distance_b10000p0")
...
for ( i in 1:50){
  ...
  #model 1: Selection of important variables, added b10000p10 and 0 
  data1 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, precMax_b50, precMax_b10000, precMin_b50, precMin_b100000, precMaxAmplitude_b50, precMaxAmplitude_b10000,
                              tempAv_b1000, tempAv_b100000, elevation_b100000, elevation_b50, distance_b100000p70, distance1000_b100000p70, distance5000_b100000p70,
                              travelTime_b100000, travelTime_b1000, precAv_b100000, precAv_b50, 
                              distance_b100000p10, distance_b50p50, distance_b1000p70, distance_b100000p0, distance500_b50p10, distance1000_b10000p10, 
                              distance5000_b100000p90, waterBodies_b10000p10, waterBodies_b100000p10, waterArea_b100000p90, distance_b10000p10, distance_b10000p0, waterNDWI_b100000p50))
  BRT_malaria1 <- gbm.fixed(data=data1, gbm.x=2:34 ,gbm.y=1, family="gaussian", tree.complexity = 10, learning.rate = 0.005, n.trees = 5000,  bag.fraction = 0.6)
  
  
  #model 2: Model 1 without precipitation high res no precipitation 
  data2 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, tempAv_b1000, tempAv_b10000, elevation_b100000, elevation_b50, distance_b100000p70, distance1000_b100000p70, distance5000_b100000p70,
                              travelTime_b100000, travelTime_b1000, distance_b100000p10, distance_b50p50, distance_b1000p70, distance_b100000p0, distance500_b50p10, distance1000_b10000p10, 
                              distance5000_b100000p90, waterBodies_b10000p10, waterBodies_b100000p10, waterArea_b100000p90, distance_b10000p10, distance_b10000p0, waterNDWI_b100000p50))
  BRT_malaria2 <- gbm.fixed(data=data2, gbm.x=2:26 ,gbm.y=1, family="gaussian", tree.complexity = 10, learning.rate = 0.005, n.trees = 5000,  bag.fraction = 0.6)

  #model 3: Model 1 without surface water -- only precipitation
  data3 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, precMax_b50, precMax_b10000, precMin_b50, precMin_b100000, precMaxAmplitude_b50, precMaxAmplitude_b10000,
                              tempAv_b1000, tempAv_b100000, elevation_b100000, elevation_b50,
                              travelTime_b100000, travelTime_b1000, precAv_b100000, precAv_b50))
  BRT_malaria3 <- gbm.fixed(data=data3, gbm.x=2:17 ,gbm.y=1, family="gaussian", tree.complexity = 10, learning.rate = 0.005, n.trees = 5000,  bag.fraction = 0.6)

  # #model 4: Smallest and largest of every variable
  # data4 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, precMax_b50, precMax_b10000, precMin_b50, precMin_b100000, precMaxAmplitude_b50, precMaxAmplitude_b10000,
  #                             tempAv_b1000, tempAv_b100000, elevation_b100000, elevation_b50, distance_b100000p70, distance1000_b100000p70, distance5000_b100000p70,
  #                             travelTime_b100000, travelTime_b1000, precAv_b100000, precAv_b50, 
  #                             distance_b100000p10, distance_b50p50, distance_b1000p70, distance_b100000p0, distance500_b50p10, distance1000_b10000p10, 
  #                             distance5000_b100000p90, waterBodies_b10000p10, waterBodies_b100000p10, waterArea_b100000p90, distance_b10000p10, distance_b10000p0))
  # BRT_malaria4 <- gbm.fixed(data=data4, gbm.x=2:32 ,gbm.y=1, family="gaussian", tree.complexity = 5, learning.rate = 0.005, n.trees = 2000,  bag.fraction = 0.6)
  # 
  # #model 5: Only precipitation 
  # data5 <- select(training, c(pf_pr, starts_with("precAv")))
  ...
  # data7 <- select(training, c(pf_pr, starts_with("housingMean"), starts_with("travelTime"), starts_with("popDensity"), starts_with("meanITN"), starts_with("tempAv"), starts_with("elevation"), starts_with("precAv"), contains("waterArea5000_b"), contains("distance5000_b")))
  ...
  predictions <- list(preds1, preds2, preds3)
  ...
  deviance <- rbind(BRT_malaria1$self.statistics$resid.deviance, BRT_malaria2$self.statistics$resid.deviance, BRT_malaria3$self.statistics$resid.deviance)
  ...
  # Var1 <- partial(BRT_malaria1, pred.var = c("distance_b100000p10"), train = data1, n.trees = 5000)
  # Var1Y <- cbind(Var1Y, Var1$yhat)
  # 
  # Var2 <- partial(BRT_malaria2, pred.var = c("distance_b100000p10"), train = data2, n.trees = 5000)
  # Var2Y <- cbind(Var2Y, Var2$yhat)
  # 
  # Var3 <- partial(BRT_malaria1, pred.var = c("distance5000_b100000p90"), train = data1, n.trees = 5000)
  # Var3Y <- cbind(Var3Y, Var3$yhat)
  # 
  # Var4 <- partial(BRT_malaria2, pred.var = c("distance5000_b100000p90"), train = data2, n.trees = 5000)
  # Var4Y <- cbind(Var4Y, Var4$yhat)

  # Var5 <- partial(BRT_malaria1, pred.var = c("precAv_b100000"), train = data1, n.trees = 5000)
  # Var5Y <- cbind(Var5Y, Var5$yhat)
  # 
  # Var6 <- partial(BRT_malaria3, pred.var = c("precAv_b100000"), train = data3, n.trees = 5000)
  # Var6Y <- cbind(Var6Y, Var6$yhat)
  # 
  # Var7 <- partial(BRT_malaria1, pred.var = c("waterNDWI_b100000p50"), train = data1, n.trees = 7000)
  # Var7Y <- cbind(Var7Y, Var7$yhat)
  # 
  # Var8 <- partial(BRT_malaria2, pred.var = c("waterNDWI_b100000p50"), train = data2, n.trees = 8000)
  # Var8Y <- cbind(Var8Y, Var8$yhat)
...
Var1Y$x <- Var1$distance_b100000p10
write.csv(Var1Y, file=sprintf("Results/pdpPlots/var1%s.csv", runName), row.names = FALSE)


Var2Y$mean <- rowMeans(Var2Y)
Var2Y$x <- Var2$distance_b100000p10
write.csv(Var2Y, file=sprintf("Results/pdpPlots/var2%s.csv", runName), row.names = FALSE)

Var3Y$mean <- rowMeans(Var3Y)
Var3Y$x <- Var3$distance5000_b100000p90
write.csv(Var3Y, file=sprintf("Results/pdpPlots/var3%s.csv", runName), row.names = FALSE)

Var4Y$mean <- rowMeans(Var4Y)
Var4Y$x <- Var4$distance5000_b100000p90
write.csv(Var4Y, file=sprintf("Results/pdpPlots/var4%s.csv", runName), row.names = FALSE)

Var5Y$mean <- rowMeans(Var5Y)
Var5Y$x <- Var5$precAv_b100000
write.csv(Var5Y, file=sprintf("Results/pdpPlots/var5%s.csv", runName), row.names = FALSE)

Var6Y$mean <- rowMeans(Var6Y)
Var6Y$x <- Var6$precAv_b100000
write.csv(Var6Y, file=sprintf("Results/pdpPlots/var6%s.csv", runName), row.names = FALSE)

Var7Y$mean <- rowMeans(Var7Y)
Var7Y$x <- Var7$waterNDWI_b100000p50
write.csv(Var7Y, file=sprintf("Results/pdpPlots/var7%s.csv", runName), row.names = FALSE)

Var8Y$mean <- rowMeans(Var8Y)
Var8Y$x <- Var8$waterNDWI_b100000p50
write.csv(Var8Y, file=sprintf("Results/pdpPlots/var8%s.csv", runName), row.names = FALSE)
