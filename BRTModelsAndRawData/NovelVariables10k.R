...
RCModel1 = data.frame(matrix(ncol=0,nrow=32))
Rx1 <- c("NDVI_b50", "NDVI_b10000", "precMax_b50", "precMax_b10000", "precMin_b50", "precMin_b10000", "precMaxAmplitude_b50", "precMaxAmplitude_b10000","tempAv_b1000", "tempAv_b10000", 
         "elevation_b10000", "elevation_b50", "distance_b10000p70", "distance1000_b10000p70", "distance5000_b10000p70", "travelTime_b10000", "travelTime_b1000", "precAv_b10000", 
         "precAv_b50", "distance_b10000p10", "distance_b50p50", "distance_b1000p70", "distance_b10000p0", "distance500_b50p10", "distance1000_b10000p10", "distance5000_b10000p90", 
          "waterBodies_b10000p10", "waterArea_b10000p90", "waterNDWI_b10000p50", "waterBodies_b1000p10", "distance_b1000p0", "distance_b1000p10")
RCModel1 <- RCModel1 %>% cbind(RCModel1, Rx1) %>% rename("var" = "Rx1")

RCModel2 = data.frame(matrix(ncol=0,nrow=24))
Rx2 <- c("NDVI_b50", "NDVI_b10000", "tempAv_b1000", "tempAv_b10000", "elevation_b10000", "elevation_b50", "distance_b10000p70", "distance1000_b10000p70", "distance5000_b10000p70", "travelTime_b10000", 
         "travelTime_b1000", "distance_b10000p10", "distance_b50p50", "distance_b1000p70", "distance_b10000p0", "distance500_b50p10", "distance1000_b10000p10", "distance5000_b10000p90", "waterBodies_b10000p10", 
         "waterArea_b10000p90", "waterNDWI_b10000p50", "waterBodies_b1000p10", "distance_b1000p0", "distance_b1000p10")
RCModel2 <- RCModel2 %>% cbind(RCModel2, Rx2) %>% rename("var" = "Rx2")

RCModel3 = data.frame(matrix(ncol=0,nrow=16))
Rx3 <- c("NDVI_b50", "NDVI_b10000", "precMax_b50", "precMax_b10000", "precMin_b50", "precMin_b10000", "precMaxAmplitude_b50", "precMaxAmplitude_b10000", "tempAv_b1000", "tempAv_b10000", 
         "elevation_b10000", "elevation_b50", "travelTime_b10000", "travelTime_b1000", "precAv_b10000", "precAv_b50")
RCModel3 <- RCModel3 %>% cbind(RCModel3, Rx3) %>% rename("var" = "Rx3")

# RCModel4 = data.frame(matrix(ncol=0,nrow=31))
# Rx4 <- c("NDVI_b50", "NDVI_b10000", "precMax_b50", "precMax_b10000", "precMin_b50", "precMin_b10000", "precMaxAmplitude_b50", "precMaxAmplitude_b10000","tempAv_b1000", "tempAv_b10000", 
#          "elevation_b10000", "elevation_b50", "distance_b10000p70", "distance1000_b10000p70", "distance5000_b10000p70", "travelTime_b10000", "travelTime_b1000", "precAv_b10000", 
#          "precAv_b50", "distance_b10000p10", "distance_b50p50", "distance_b1000p90", "distance_b10000p20", "distance500_b50p10", "distance1000_b10000p10", "distance5000_b10000p90", 
#          "waterBodies_b10000p10", "waterBodies_b10000p10", "waterArea_b10000p90", "distance_b10000p10", "distance_b10000p0")
...
for ( i in 1:50){
  ...
  #model 1: Best total selection -- optimal
  data1 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, precMax_b50, precMax_b10000, precMin_b50, precMin_b10000, precMaxAmplitude_b50, precMaxAmplitude_b10000,
                              tempAv_b1000, tempAv_b10000, elevation_b10000, elevation_b50, distance_b10000p70, distance1000_b10000p70, distance5000_b10000p70,
                              travelTime_b10000, travelTime_b1000, precAv_b10000, precAv_b50, waterBodies_b1000p10, distance_b1000p0, distance_b1000p10,
                              distance_b10000p10, distance_b50p50, distance_b1000p70, distance_b10000p0, distance500_b50p10, distance1000_b10000p10, 
                              distance5000_b10000p90, waterBodies_b10000p10, waterArea_b10000p90, waterNDWI_b10000p50))
  BRT_malaria1 <- gbm.fixed(data=data1, gbm.x=2:33 ,gbm.y=1, family="gaussian", tree.complexity = 10, learning.rate = 0.005, n.trees = 5000,  bag.fraction = 0.6)
  
  
  #model 2: Model 1 without precipitation -- high res no precipitation 
  data2 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, tempAv_b1000, tempAv_b10000, elevation_b10000, elevation_b50, distance_b10000p70, distance1000_b10000p70, distance5000_b10000p70,
                              travelTime_b10000, travelTime_b1000, distance_b10000p10, distance_b50p50, distance_b1000p70, distance_b10000p0, distance500_b50p10, distance1000_b10000p10, 
                              distance5000_b10000p90,waterBodies_b10000p10, waterArea_b10000p90, waterNDWI_b10000p50, waterBodies_b1000p10, distance_b1000p0, distance_b1000p10))
  BRT_malaria2 <- gbm.fixed(data=data2, gbm.x=2:25 ,gbm.y=1, family="gaussian", tree.complexity = 10, learning.rate = 0.005, n.trees = 5000,  bag.fraction = 0.6)
  ...
  data3 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, precMax_b50, precMax_b10000, precMin_b50, precMin_b10000, precMaxAmplitude_b50, precMaxAmplitude_b10000,
                              tempAv_b1000, tempAv_b10000, elevation_b10000, elevation_b50,
                              travelTime_b10000, travelTime_b1000, precAv_b10000, precAv_b50))
  ...
  #                             travelTime_b10000, travelTime_b1000, precAv_b10000, precAv_b50, 
  #                             distance_b10000p10, distance_b50p50, distance_b1000p70, distance_b10000p0, distance500_b50p10, distance1000_b10000p10, 
  #                             distance5000_b10000p90, waterBodies_b10000p10, waterBodies_b10000p10, waterArea_b10000p90, distance_b10000p10, distance_b10000p0))
  ...
  # Var1 <- partial(BRT_malaria1, pred.var = c("distance_b10000p10"), train = data1, n.trees = 5000)
  # Var1Y <- cbind(Var1Y, Var1$yhat)
  # 
  # Var2 <- partial(BRT_malaria2, pred.var = c("distance_b10000p10"), train = data2, n.trees = 5000)
  # Var2Y <- cbind(Var2Y, Var2$yhat)
  # 
  # Var3 <- partial(BRT_malaria1, pred.var = c("distance5000_b10000p90"), train = data1, n.trees = 5000)
  # Var3Y <- cbind(Var3Y, Var3$yhat)
  # 
  # Var4 <- partial(BRT_malaria2, pred.var = c("distance5000_b10000p90"), train = data2, n.trees = 5000)
  # Var4Y <- cbind(Var4Y, Var4$yhat)
  
  # Var5 <- partial(BRT_malaria1, pred.var = c("precAv_b10000"), train = data1, n.trees = 5000)
  # Var5Y <- cbind(Var5Y, Var5$yhat)
  # 
  # Var6 <- partial(BRT_malaria3, pred.var = c("precAv_b10000"), train = data3, n.trees = 5000)
  # Var6Y <- cbind(Var6Y, Var6$yhat)
  # 
  # Var7 <- partial(BRT_malaria1, pred.var = c("waterNDWI_b10000p50"), train = data1, n.trees = 7000)
  # Var7Y <- cbind(Var7Y, Var7$yhat)
  # 
  # Var8 <- partial(BRT_malaria2, pred.var = c("waterNDWI_b10000p50"), train = data2, n.trees = 8000)
