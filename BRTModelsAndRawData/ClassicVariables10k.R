...
Rx1 <- c("NDVI_b50", "NDVI_b10000", "tempAv_b1000", "tempAv_b10000", 
         "elevation_b10000", "elevation_b50", "travelTime_b10000", "travelTime_b1000")
RCModel1 <- RCModel1 %>% cbind(RCModel1, Rx1) %>% rename("var" = "Rx1")

RCModel2 = data.frame(matrix(ncol=0,nrow=18))
Rx2 <- c("NDVI_b50", "NDVI_b10000", "precMax_b50", "precMax_b10000", "precMin_b50", "precMin_b10000", "precMaxAmplitude_b50", "precMaxAmplitude_b10000", "tempAv_b1000", "tempAv_b10000", 
         "elevation_b10000", "elevation_b50", "travelTime_b10000", "travelTime_b1000", "precAv_b10000", "precAv_b50", "waterNDWI_b10000p50", "distance30_b50p50")
...
for ( i in 1:50){
  ...
  data1 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, tempAv_b1000, tempAv_b10000, elevation_b10000, elevation_b50, travelTime_b10000, travelTime_b1000))
  ...
  #model 2: Confounders + solano-villareal et al variables: NDWI at 10km buffer, distance to seasonal water bodies (50% persistence) classic scenario
  data2 <- select(training, c(pf_pr, NDVI_b50, NDVI_b10000, precMax_b50, precMax_b10000, precMin_b50, precMin_b10000, precMaxAmplitude_b50, precMaxAmplitude_b10000,
                              tempAv_b1000, tempAv_b10000, elevation_b10000, elevation_b50, travelTime_b10000, travelTime_b1000, precAv_b10000, precAv_b50,
                              waterNDWI_b10000p50, distance30_b50p50))
  ...
  # Var1 <- partial(BRT_malaria1, pred.var = c("waterNDWI_b10000p50"), train = data1, n.trees = 2000)
...
Var1Y$x <- Var1$waterNDWI_b10000p50
